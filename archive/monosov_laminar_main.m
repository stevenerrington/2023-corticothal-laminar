...
% Session list
session_list = {'LemmyKim-08142023-001_MYInfoPavChoice',...
    'LemmyKim-08152023-001_MYInfoPavChoice',...
    'LemmyKim-08162023-001_MYInfoPavChoice'};

% Area list
area_list = {'vlpfc','acc','thalamus'};

%% Extract/curate date for CSD analyses
clear csd_signal_save
...
for session_i = 1:length(session_list)
    ...
    for area_i = 1:length(area_list)
        ...
        csd_signal_save{session_i,area_i} = csd_signal_out;
    end
end
